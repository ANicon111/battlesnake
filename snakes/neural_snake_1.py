...
from neural_snake_1_data.step_2_train_network import DirectionNetwork
...
class NeuralAgent:
    def __init__(self, model_path):
        ...
        if saved["input_columns"] != INPUT_COLUMNS or saved["actions"] != ACTIONS:
            raise ValueError(
                "Model columns/actions differ from this project. Record and train again after changing inputs."
            )
